...
public class GuiFEConverter extends GuiIC2<ContainerFEConverter> {
    ...
    protected void drawForegroundLayer(int par1, int par2) {
        ...
        this.fontRenderer.drawString("FE: " + ModUtils.getString(this.tileentity.energy2) + "/" + ModUtils.getString(this.tileentity.maxStorage2),
                9, 30, 13487565
        );
        if (this.tileentity.rf) {
            ...
            this.fontRenderer.drawString("OUT: " + ModUtils.getString(this.tileentity.differenceenergy) + " FE/t", 9, 60,
                    13487565
            );
        } else {
            this.fontRenderer.drawString(
