...
public class TileEntityQuadMacerator extends TileEntityMultiMachine {
	public TileEntityQuadMacerator() {
		super(EnumMultiMachine.QUAD_MACERATOR.usagePerTick,EnumMultiMachine.QUAD_MACERATOR.lenghtOperation, Recipes.macerator,0);
	...
	public String getInventoryName() {
		return StatCollector.translateToLocal("iu.blockMacerator3.name");
	}
