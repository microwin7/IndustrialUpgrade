...
import com.denfop.container.ContainerImpNuclearReactor;
import com.denfop.damagesource.IUDamageSource;
import com.denfop.gui.GuiImpNuclearReactor;
import com.denfop.invslot.InvSlotReactor1;
...
public class TileEntityImpNuclearReactor extends TileEntityInventory implements IHasGui, IReactor, IEnergySource, IMetaDelegate, IFluidHandler {
    ...
    public final InvSlotReactor1 reactorSlot;
    ...
    public TileEntityImpNuclearReactor() {
        ...
        this.reactorSlot = new InvSlotReactor1(this, "reactor", 0, 66);
        this.coolantinputSlot = new InvSlotConsumableLiquidByList(this, "coolantinputSlot", 61, Access.I, 1, InvSide.ANY, OpType.Drain, BlocksItems.getFluid(InternalName.fluidCoolant));
        this.hotcoolinputSlot = new InvSlotConsumableLiquidByTank(this, "hotcoolinputSlot", 62, Access.I, 1, InvSide.ANY, OpType.Fill, this.outputTank);
        this.coolantoutputSlot = new InvSlotOutput(this, "coolantoutputSlot", 63, 1);
        this.hotcoolantoutputSlot = new InvSlotOutput(this, "hotcoolantoutputSlot", 64, 1);
        this.getblock = false;
    }
...
//TODO y <7 this height of the reactor is 7 maximum, for the rest change 7 to your value
    ...
    public ContainerBase<TileEntityImpNuclearReactor> getGuiContainer(EntityPlayer entityPlayer) {
        return new ContainerImpNuclearReactor(entityPlayer, this);
    }

    @SideOnly(Side.CLIENT)
    public GuiScreen getGui(EntityPlayer entityPlayer, boolean isAdmin) {
        return new GuiImpNuclearReactor(new ContainerImpNuclearReactor(entityPlayer, this));
    }
