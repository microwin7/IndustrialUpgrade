...
public enum EnumType
{
    ...
    EnumType(double coefficient_nether,double coefficient_end,double coefficient_day, double coefficient_night, double coefficient_rain,int meta,String name){
    ...
    public static void register(){
        for(EnumType type : values())
            IUItem.type.put(type.meta,type);
    }
}
