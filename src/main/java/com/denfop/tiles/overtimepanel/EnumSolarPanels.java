...
public enum EnumSolarPanels {
    ...
    DIAMOND_SOLAR_PANEL(null, IUItem.blockpanelcustom, 14, TileEntityDiamondSolarPanel.class, "Diamond Solar Panel", "blockDiamondSolarPanel.name", 1, Config.diamondpanelGenDay, Config.diamondpanelstorage, Config.diamondpanelOutput, true, "default", "diamond_top", true),
    FLICKER_SOLAR_PANEL(DIAMOND_SOLAR_PANEL, IUItem.blockpanelcustom, 14, TileEntityFlickerSolarPanel.class, "Flicker Solar Panel", "blockFlickerSolarPanel.name", 1, Config.flickerpanelGenDay, Config.flickerpanelstorage, Config.flickerpanelOutput, true, "default", "flicker_top", true),
