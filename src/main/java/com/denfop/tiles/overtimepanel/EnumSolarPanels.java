...
public enum EnumSolarPanels {
    ...
    PERFECT_SOLAR_PANEL(HYBRID_SOLAR_PANEL, IUItem.blockpanel, 2, TileEntityUltimateSolarPanel.class, "Perfect Solar Panel", "blockUltimateSolarPanel.name", 3, Config.uhGenDay, Config.uhStorage, Config.uhOutput, true, "default", "usp_top", true),
