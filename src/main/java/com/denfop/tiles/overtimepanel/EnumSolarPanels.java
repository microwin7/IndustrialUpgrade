...
public enum EnumSolarPanels {
    ...
    ADVANCED_SOLAR_PANEL(null, IUItem.blockpanel, 0, TileEntityAdvancedSolarPanel.class, "Advanced Solar Panel", "blockAdvancedSolarPanel.name", 1, Config.advGenDay, Config.advStorage, Config.advOutput, true, "default", "asp_top", true),
    HYBRID_SOLAR_PANEL(ADVANCED_SOLAR_PANEL, IUItem.blockpanel, 1, TileEntityHybridSolarPanel.class, "Hybrid Solar Panel", "blockHybridSolarPanel.name", 2, Config.hGenDay, Config.hStorage, Config.hOutput, true, "default", "hsp_top", true),
    PERFECT_SOLAR_PANEL(HYBRID_SOLAR_PANEL, IUItem.blockpanel, 2, TileEntityPerfectSolarPanel.class, "Perfect Solar Panel", "blockUltimateSolarPanel.name", 3, Config.uhGenDay, Config.uhStorage, Config.uhOutput, true, "default", "usp_top", true),
    QUANTUM_SOLAR_PANEL(PERFECT_SOLAR_PANEL, IUItem.blockpanel, 3, TileEntityQuantumSolarPanel.class, "Quantum Solar Panel", "blockQuantumSolarPanel.name", 4, Config.qpGenDay, Config.qpStorage, Config.qpOutput, true, "default", "qsp_top", true),
    SPECTRAL_SOLAR_PANEL(QUANTUM_SOLAR_PANEL, IUItem.blockpanel, 4, TileEntitySpectralSolarPanel.class, "Spectral Solar Panel", "blockSpectralSolarPanel.name", 5, Config.spectralpanelGenDay, Config.spectralpanelstorage, Config.spectralpanelOutput, true, "default", "spsp_top", true),
    PROTON_SOLAR_PANEL(SPECTRAL_SOLAR_PANEL, IUItem.blockpanel, 5, TileEntityProtonSolarPanel.class, "Proton Solar Panel", "blockProtonSolarPanel.name", 6, Config.protongenDay, Config.protonstorage, Config.protonOutput, true, "default", "psp_top", true),
    SINGULAR_SOLAR_PANEL(PROTON_SOLAR_PANEL, IUItem.blockpanel, 6, TileEntitySingularSolarPanel.class, "Singular Solar Panel", "blockSingularSolarPanel.name", 7, Config.singularpanelGenDay, Config.singularpanelstorage, Config.singularpanelOutput, true, "default", "ssp_top", true),
    DIFFRACTION_SOLAR_PANEL(SINGULAR_SOLAR_PANEL, IUItem.blockpanel, 7, TileEntityDiffractionSolarPanel.class, "Diffraction Solar Panel", "blockAdminSolarPanel.name", 8, Config.adminpanelGenDay, Config.AdminpanelStorage, Config.AdminpanelOutput, true, "default", "admsp_model", true),
    PHOTONIC_SOLAR_PANEL(DIFFRACTION_SOLAR_PANEL, IUItem.blockpanel, 8, TileEntityPhotonicSolarPanel.class, "Photon Solar Panel", "blockPhotonicSolarPanel.name", 9, Config.photonicpanelGenDay, Config.photonicpanelStorage, Config.photonicpanelOutput, true, "default", "phsp_top", true),
    NEUTRONIUN_SOLAR_PANEL(PHOTONIC_SOLAR_PANEL, IUItem.blockpanel, 9, TileEntityNeutronSolarPanel.class, "Neutron Solar Panel", "blockNeutronSolarPanel.name", 10, Config.neutronpanelGenDay, Config.neutronpanelStorage, Config.neutronpanelOutput, true, "default", "nsp_top", true),
    ...
    HV_SOLAR_PANEL(LV_SOLAR_PANEL, Loader.isModLoaded("CompactSolars") ? CompactSolarIntegration.solar : null, 1, null, null, "tile.compactsolars:MV_block.name", 2, 64, 256, 64, false, "compact", "hv_model", false),
    MV_SOLAR_PANEL(HV_SOLAR_PANEL, Loader.isModLoaded("CompactSolars") ? CompactSolarIntegration.solar : null, 2, null, null, "tile.compactsolars:HV_block.name", 3, 512, 1024, 512, false, "compact", "mv_model", false),
