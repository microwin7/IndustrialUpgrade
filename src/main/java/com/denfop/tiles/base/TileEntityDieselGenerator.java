...
public class TileEntityDieselGenerator extends TileEntityLiquidTankInventory implements IEnergySource, IHasGui, INetworkTileEntityEventListener {
    ...
    public void onBlockBreak(Block block, int meta) {
        FluidEvent.fireEvent(new FluidSpilledEvent(new FluidStack(BlocksItems.getFluid("fluiddizel"), 1000), this.worldObj, this.xCoord, this.yCoord, this.zCoord));
    }
}
