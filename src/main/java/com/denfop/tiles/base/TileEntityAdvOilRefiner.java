...
public class TileEntityAdvOilRefiner extends TileEntityElectricMachine implements IFluidHandler, IHasGui, IUpgradableBlock, INetworkTileEntityEventListener {
    ...
    public TileEntityAdvOilRefiner() {
        ...
        this.containerslot = new InvSlotConsumableLiquidByList(this,
                ...
                BlocksItems.getFluid("fluidpolyeth"));
