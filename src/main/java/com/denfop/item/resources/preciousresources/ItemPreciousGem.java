...
package com.denfop.item.resources.preciousresources;
...
public class ItemPreciousGem extends Item {
    ...
    public void addItemsNames() {
        ...
        this.itemNames.add("ruby_gem");
        this.itemNames.add("sapphire_gem");
        this.itemNames.add("topaz_gem");
    }
