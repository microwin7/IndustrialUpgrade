...
public class ItemMoreMachine3 extends ItemBlock {
    public ItemMoreMachine3(Block block) {
        super(block);
        setMaxDamage(0);
        setHasSubtypes(true);
    ...
    public String getUnlocalizedName(ItemStack itemstack) {
        return "iu.block" + BlockMoreMachine3.names[itemstack.getItemDamage()];
    }
    ...
    public void getSubItems(Item par1, CreativeTabs par2CreativeTabs, List par3List) {
        for (int i = 0; i < BlockMoreMachine3.names.length; i++)
