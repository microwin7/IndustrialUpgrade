...
public class ContainerOilRefiner extends ContainerFullInv<TileEntityOilRefiner> {
    public ContainerOilRefiner(EntityPlayer entityPlayer, TileEntityOilRefiner tileEntity1) {
