...
public class ContainerImpNuclearReactor extends ContainerBase<TileEntityImpNuclearReactor> {
    public final short size;

    public ContainerImpNuclearReactor(EntityPlayer entityPlayer, TileEntityImpNuclearReactor tileEntity1) {
        super(tileEntity1);
