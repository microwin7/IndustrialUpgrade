...
public class Config {
    ...
    public static void config(final FMLPreInitializationEvent event) {
        ...
        impheatswitch_heatStorage1 = config.get("Configuration of upgrade reactors", "impheatswitch_heatStorage1", 5000).getInt(5000);
        impheatswitch_switchside = config.get("Configuration of upgrade reactors", "impheatswitch_switchside", 60).getInt(60);
        impheatswitch_switchreactor = config.get("Configuration of upgrade reactors", "impheatswitch_switchreactor", 70).getInt(70);
        ...
        reactoradvVent_heatStorage1 = config.get("Configuration of upgrade reactors", "reactoradvVent_heatStorage1", 1000).getInt(1000);
        reactoradvVent_selfvent = config.get("Configuration of upgrade reactors", "reactoradvVent_selfvent", 25).getInt(25);
        reactoradvVent_reactorvent = config.get("Configuration of upgrade reactors", "reactoradvVent_reactorvent", 35).getInt(35);
        ...
        InfinityGenDay = config.get("Configuration Solar Panels(Integration)", "InfinityGenDay", 21211520D).getDouble(21211520D);
        InfinityOutput = config.get("Configuration Solar Panels(Integration)", "InfinityOutput", 42423040D).getDouble(42423040D);
        ...
        neutrongenday = config.get("Configuration Solar Panels(Integration)", "NeutronGenDay", 1325720D).getDouble(1325720D);
        neutronOutput = config.get("Configuration Solar Panels(Integration)", "NeutronOutput", 2651440D).getDouble(2651440D);
        ...
        terasteelstorage = config.get("Configuration Solar Panels(Integration)", "Terasteelstorage", 5000000D).getDouble(5000000D);
        terasteeloutput = config.get("Configuration Solar Panels(Integration)", "Terasteeloutput", 2560D).getDouble(2560D);
        ...
        draconicoutput = config.get("Configuration Solar Panels(Integration)", "Draconicoutput", 160D).getDouble(160D);
        draconictier = config.get("Configuration Solar Panels(Integration)", "Draconictier", 3).getInt(3);
        awakenedgenday = config.get("Configuration Solar Panels(Integration)", "Awakanedgenday", 20480D).getDouble(20480D);
        awakenedstorage = config.get("Configuration Solar Panels(Integration)", "Awakanedstorage", 1.0E9).getDouble(1.0E9);
        awakenedoutput = config.get("Configuration Solar Panels(Integration)", "Awakanedoutput", 40960D).getDouble(40960D);
        awakenedtier = config.get("Configuration Solar Panels(Integration)", "Awakanedtier", 7).getInt(7);
        chaosgenday = config.get("Configuration Solar Panels(Integration)", "Chaosgenday", 1325720D).getDouble(1325720D);
        ...
        //
        thaumgenday = config.get("Configuration Solar Panels(Integration)", "Thaumgenday", 80D).getDouble(80D);
        thaumstorage = config.get("Configuration Solar Panels(Integration)", "Thaumstorage", 50000D).getDouble(50000D);
        thaumoutput = config.get("Configuration Solar Panels(Integration)", "Thaumoutput", 160D).getDouble(160D);
        thaumtier = config.get("Configuration Solar Panels(Integration)", "Thaumtier", 3).getInt(3);
        voidgenday = config.get("Configuration Solar Panels(Integration)", "Voidgenday", 320D).getDouble(320D);
        voidstorage = config.get("Configuration Solar Panels(Integration)", "Voidstorage", 200000D).getDouble(200000D);
        voidoutput = config.get("Configuration Solar Panels(Integration)", "Voidoutput", 640D).getDouble(640D);
        voidtier = config.get("Configuration Solar Panels(Integration)", "Voidtier", 4).getInt(4);
        ihorgenday = config.get("Configuration Solar Panels(Integration)", "Ihorgenday", 5120D).getDouble(5120D);
        ihorstorage = config.get("Configuration Solar Panels(Integration)", "Ihorstorage", 5.0E7).getDouble(5.0E7);
        ihoroutput = config.get("Configuration Solar Panels(Integration)", "Ihoroutput", 10240D).getDouble(10240D);
