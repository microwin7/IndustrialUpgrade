...
public class GuiNeutronGenerator extends GuiIC2 {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        this.fontRendererObj.drawString(this.container.base.getProgressAsString(), 18, 31,
                4210752);
        this.fontRendererObj.drawString(StatCollector.translateToLocal("iu.blockMatter.name"), 30, 6, 4210752);

        super.drawGuiContainerForegroundLayer(par1, par2);
        FluidStack fluidstack = this.container.base.getFluidStackfromTank();
        if (fluidstack != null) {
            String tooltip = StatCollector.translateToLocal("iu.fluidNeutron") + ": " + fluidstack.amount
