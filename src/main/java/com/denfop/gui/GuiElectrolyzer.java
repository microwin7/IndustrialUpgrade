...
public class GuiElectrolyzer extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        if (fluidstack1 != null && fluidstack1.getFluid() != null) {
            String tooltip = StatCollector.translateToLocal("iu.fluidhyd") + ": " + fluidstack1.amount + "mB";
        ...
        if (fluidstack2 != null && fluidstack2.getFluid() != null) {
            String tooltip = StatCollector.translateToLocal("iu.fluidoxy") + ": " + fluidstack2.amount + "mB";
    ...
    static {
        background = new ResourceLocation(Constants.TEXTURES, "textures/gui/GUIElectolyzer.png");
    }
}
