 ...
 * @author bspkrs
 */
public class GuiAdvCheckBox extends GuiCheckBox {

    private final int boxWidth;
    private boolean isChecked;

    public GuiAdvCheckBox(int id, int xPos, int yPos, String displayString, boolean isChecked) {
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY, float partial) {
        if (this.visible) {
            ...
            this.drawString(mc.fontRenderer, displayString, this.x, this.y + 11, color);
        }
    }
