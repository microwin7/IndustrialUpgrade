...
public class GuiMultiMatter extends GuiIC2 {
	...
	public void initGui() {
		super.initGui();
		this.buttonList.add(new GuiButton(0, (this.width - this.xSize) / 2 + 8, (this.height - this.ySize) / 2 + 66,
				72, 17,this.container.base.work ? I18n.format("button.deny") :  I18n.format("button.allow")));
	}
	...
	protected void actionPerformed(GuiButton guibutton) {
		...
		IC2.network.get().initiateClientTileEntityEvent( this.container.base,
				guibutton.id);
		super.updateScreen();
	}
