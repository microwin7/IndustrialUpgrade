...
//
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.NanoBoots, 1, OreDictionary.WILDCARD_VALUE),
                " A ", "BCB", "DED", 'A', new ItemStack(IUItem.QuantumItems9, 1), 'B', OreDictionary.getOres("doubleplateRedbrass"), 'C', new ItemStack(Ic2Items.lapotronCrystal.getItem(), 1, OreDictionary.WILDCARD_VALUE), 'D', new ItemStack(IUItem.compresscarbon), 'E', new ItemStack(Ic2Items.nanoBoots.getItem(), 1, OreDictionary.WILDCARD_VALUE));
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.NanoLeggings, 1, OreDictionary.WILDCARD_VALUE),
                "DED", "BCB", "FAF", 'A', new ItemStack(IUItem.QuantumItems9, 1), 'B', OreDictionary.getOres("plateRedbrass"), 'C', new ItemStack(Ic2Items.lapotronCrystal.getItem(), 1, OreDictionary.WILDCARD_VALUE), 'D', new ItemStack(IUItem.compresscarbon), 'E', new ItemStack(Ic2Items.nanoLeggings.getItem(), 1, OreDictionary.WILDCARD_VALUE), 'F', OreDictionary.getOres("plateAluminumbronze"));
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.NanoHelmet, 1, OreDictionary.WILDCARD_VALUE),
                "DCD", "BEB", "FGF", 'A', new ItemStack(Ic2Items.electricJetpack.getItem(), 1, OreDictionary.WILDCARD_VALUE), 'B', new ItemStack(IUItem.compresscarbon, 1), 'C', new ItemStack(Ic2Items.lapotronCrystal.getItem(), 1, OreDictionary.WILDCARD_VALUE), 'D', OreDictionary.getOres("doubleplateAlcled"), 'E', new ItemStack(Ic2Items.nanoHelmet.getItem(), 1, OreDictionary.WILDCARD_VALUE), 'F', OreDictionary.getOres("doubleplateFerromanganese"), 'G', new ItemStack(IUItem.QuantumItems9));
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.electricblock, 1, 9),
                "EBE", "DAD", "CBC", 'D', new ItemStack(IUItem.core, 1, 11), 'E', new ItemStack(IUItem.compressIridiumplate), 'A', new ItemStack(IUItem.electricblock, 1, 8), 'C', new ItemStack(IUItem.circuitSpectral), 'B', new ItemStack(IUItem.lapotronCrystal, 1, OreDictionary.WILDCARD_VALUE));
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.electricblock, 1, 10),
                "EBE", "DAD", "CBC", 'D', new ItemStack(IUItem.core, 1, 12), 'E', new ItemStack(IUItem.doublecompressIridiumplate), 'A', new ItemStack(IUItem.electricblock, 1, 9), 'C', new ItemStack(IUItem.circuitSpectral), 'B', new ItemStack(IUItem.lapotronCrystal, 1, OreDictionary.WILDCARD_VALUE));
        ...
        Recipes.advRecipes.addRecipe(IUItem.tranformerUpgrade,
                "BCB", "CDC", "BCB", 'B', new ItemStack(IUItem.QuantumItems9), 'D', Ic2Items.transformerUpgrade, 'C', OreDictionary.getOres("plateVitalium"));

        Recipes.advRecipes.addRecipe(IUItem.tranformerUpgrade1,
                "BCB", "CDC", "BCB", 'B', new ItemStack(IUItem.cirsuitQuantum), 'D', IUItem.tranformerUpgrade, 'C', OreDictionary.getOres("plateAlcled"));

        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.nanopickaxe),
                "BCB", "CDC", "BFB", 'F', new ItemStack(Ic2Items.energyCrystal.getItem(), 1, OreDictionary.WILDCARD_VALUE), 'B', OreDictionary.getOres("doubleplateFerromanganese"), 'D', new ItemStack(Items.diamond_pickaxe), 'C', new ItemStack(IUItem.QuantumItems9, 1));

        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.nanoaxe),
                "BCB", "CDC", "BFB", 'F', new ItemStack(Ic2Items.energyCrystal.getItem(), 1, OreDictionary.WILDCARD_VALUE), 'B', OreDictionary.getOres("doubleplateFerromanganese"), 'D', new ItemStack(Items.diamond_axe), 'C', new ItemStack(IUItem.QuantumItems9, 1));

        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.nanoshovel),
                "BCB", "CDC", "BFB", 'F', new ItemStack(Ic2Items.energyCrystal.getItem(), 1, OreDictionary.WILDCARD_VALUE), 'B', OreDictionary.getOres("doubleplateFerromanganese"), 'D', new ItemStack(Items.diamond_shovel), 'C', new ItemStack(IUItem.QuantumItems9, 1));


        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.quantumpickaxe),
                "TCT", "CDC", "BFB", 'T', OreDictionary.getOres("doubleplateMuntsa"), 'F', new ItemStack(Ic2Items.lapotronCrystal.getItem(), 1, OreDictionary.WILDCARD_VALUE), 'B', new ItemStack(IUItem.quantumtool, 1), 'D', new ItemStack(IUItem.nanopickaxe, 1, OreDictionary.WILDCARD_VALUE), 'C', new ItemStack(IUItem.cirsuitQuantum, 1));

        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.quantumaxe),
                "TCT", "CDC", "BFB", 'T', OreDictionary.getOres("doubleplateMuntsa"), 'F', new ItemStack(Ic2Items.lapotronCrystal.getItem(), 1, OreDictionary.WILDCARD_VALUE), 'B', new ItemStack(IUItem.quantumtool, 1), 'D', new ItemStack(IUItem.nanoaxe, 1, OreDictionary.WILDCARD_VALUE), 'C', new ItemStack(IUItem.cirsuitQuantum, 1));

        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.quantumshovel),
                "TCT", "CDC", "BFB", 'T', OreDictionary.getOres("doubleplateMuntsa"), 'F', new ItemStack(Ic2Items.lapotronCrystal.getItem(), 1, OreDictionary.WILDCARD_VALUE), 'B', new ItemStack(IUItem.quantumtool, 1), 'D', new ItemStack(IUItem.nanoshovel, 1, OreDictionary.WILDCARD_VALUE), 'C', new ItemStack(IUItem.cirsuitQuantum, 1));
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.itemBatChargeCrystal),
                "DCD", "BAB", "ECE", 'E', OreDictionary.getOres("doubleplateVitalium"), 'D', Ic2Items.iridiumPlate, 'B', new ItemStack(IUItem.lapotronCrystal, 1, OreDictionary.WILDCARD_VALUE), 'A', new ItemStack(IUItem.advBatChargeCrystal, 1, OreDictionary.WILDCARD_VALUE), 'C', new ItemStack(IUItem.circuitSpectral));
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.quantum_bow),
                "ABA", "CDC", "EBE", 'E', OreDictionary.getOres("doubleplateAlcled"), 'C', new ItemStack(IUItem.cirsuitQuantum), 'D', new ItemStack(IUItem.nano_bow, 1, OreDictionary.WILDCARD_VALUE), 'A', Ic2Items.iridiumPlate, 'B', new ItemStack(Ic2Items.energyCrystal.getItem(), 1, OreDictionary.WILDCARD_VALUE));

        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.spectral_bow),
                "ABA", "CDC", "EBE", 'E', OreDictionary.getOres("doubleplateDuralumin"), 'C', new ItemStack(IUItem.circuitSpectral), 'D', new ItemStack(IUItem.quantum_bow, 1, OreDictionary.WILDCARD_VALUE), 'A', new ItemStack(IUItem.compressIridiumplate), 'B', new ItemStack(Ic2Items.lapotronCrystal.getItem(), 1, OreDictionary.WILDCARD_VALUE));
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.module7, 1, 3),
                "AAA", "BCB", "EFE", 'F', OreDictionary.getOres("doubleplateAlcled"), 'E', new ItemStack(IUItem.circuitSpectral), 'C', new ItemStack(IUItem.module_schedule), 'B', OreDictionary.getOres("doubleplateVitalium"), 'A', new ItemStack(IUItem.compresscarbon));

        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.module7, 1, 4),
                "AAA", "BCB", "EFE", 'F', OreDictionary.getOres("doubleplateDuralumin"), 'E', new ItemStack(IUItem.QuantumItems9), 'C', new ItemStack(IUItem.module_schedule), 'B', OreDictionary.getOres("doubleplateVanadoalumite"), 'A', new ItemStack(IUItem.compresscarbonultra));
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.module9),
                "BCA", "DED", "BCA", 'E', new ItemStack(IUItem.cirsuitQuantum, 1), 'D', OreDictionary.getOres("doubleplateSilver"), 'C', OreDictionary.getOres("doubleplateElectrum"), 'B', OreDictionary.getOres("doubleplateRedbrass"), 'A', OreDictionary.getOres("doubleplateAlcled"));
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.module8),
                "AAA", "BCB", "DED", 'E', new ItemStack(IUItem.compressIridiumplate), 'D', OreDictionary.getOres("doubleplatePlatinum"), 'C', new ItemStack(IUItem.block, 1, 2), 'B', new ItemStack(IUItem.QuantumItems9), 'A', OreDictionary.getOres("plateZinc"));
        ...
        for (int i = 0; i < RegisterOreDict.list_string.size(); i++) {
            ...
            if (i < 16)
                Recipes.advRecipes.addRecipe(new ItemStack(IUItem.block, 1, i),
                        "AAA", "AAA", "AAA", 'A', OreDictionary.getOres("ingot" + RegisterOreDict.list_string.get(i)));
            else {
        ...
        for (int i = 0; i < RegisterOreDict.list_string1.size(); i++) {
            Recipes.advRecipes.addShapelessRecipe(new ItemStack(IUItem.alloysingot, 9, i),
                    new ItemStack(IUItem.alloysblock, 1, i));
            Recipes.advRecipes.addShapelessRecipe(new ItemStack(IUItem.alloysnugget, 9, i),
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.cable, 2, 2),
                " A ", "BCB", " A ", 'C', Ic2Items.denseplatetin, 'A', new ItemStack(IUItem.cable, 1, 1), 'B', Ic2Items.advancedAlloy);
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.cable, 2, 3),
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.cable, 2, 4),
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.cable, 2, 5),
                " A ", "BCB", " A ", 'C', OreDictionary.getOres("doubleplateVitalium"), 'A', new ItemStack(IUItem.cable, 1, 4), 'B', Ic2Items.denseplateadviron);
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.cable, 2, 6),
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.cable, 2, 7),
                "A A", "BCB", "A A", 'C', new ItemStack(IUItem.photoniy_ingot), 'B', new ItemStack(IUItem.photoniy), 'A', new ItemStack(IUItem.cable, 1, 6));

        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.cable, 2, 8),
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.cable, 1, 10),
                "BBB", "ACA", "BBB", 'C', OreDictionary.getOres("doubleplateVanadoalumite"), 'A', new ItemStack(IUItem.circuitSpectral), 'B', new ItemStack(IUItem.cable, 2, 9));
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.adv_lappack),
                "ABA", "CEC", "ADA", 'E', new ItemStack(IUItem.QuantumItems9), 'D', new ItemStack(Ic2Items.lapotronCrystal.getItem(), 1, OreDictionary.WILDCARD_VALUE), 'C', OreDictionary.getOres("plateVanadoalumite"), 'B', new ItemStack(Ic2Items.lapPack.getItem(), 1, OreDictionary.WILDCARD_VALUE), 'A', OreDictionary.getOres("plateAlcled"));
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.imp_lappack),
                "ABA", "CEC", "ABA", 'E', new ItemStack(IUItem.adv_lappack, 1, OreDictionary.WILDCARD_VALUE), 'C', new ItemStack(IUItem.QuantumItems9, 1), 'B', new ItemStack(Ic2Items.lapotronCrystal.getItem(), 1, OreDictionary.WILDCARD_VALUE), 'A', OreDictionary.getOres("doubleplateFerromanganese"));
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.per_lappack),
                "ABA", "CEC", "ABA", 'E', new ItemStack(IUItem.imp_lappack, 1, OreDictionary.WILDCARD_VALUE), 'C', new ItemStack(IUItem.cirsuitQuantum, 1), 'B', new ItemStack(IUItem.compressIridiumplate, 1), 'A', OreDictionary.getOres("doubleplateVitalium"));
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.machines, 1, 1),
                "DED", "BCB", "AAA", 'E', new ItemStack(IUItem.core, 1, 5), 'D', OreDictionary.getOres("doubleplateAlumel"), 'B', new ItemStack(IUItem.cirsuitQuantum), 'C', Ic2Items.massFabricator, 'A', new ItemStack(IUItem.quantumtool));
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.machines, 1, 2),
                "DED", "BCB", "AAA", 'E', new ItemStack(IUItem.core, 1, 7), 'D', OreDictionary.getOres("doubleplateVitalium"), 'B', new ItemStack(IUItem.cirsuitQuantum), 'C', new ItemStack(IUItem.machines, 1, 1), 'A', new ItemStack(IUItem.advQuantumtool));
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.machines, 1, 3),
                "DED", "BCB", "AFA", 'F', new ItemStack(IUItem.doublecompressIridiumplate), 'E', new ItemStack(IUItem.core, 1, 8), 'D', OreDictionary.getOres("doubleplateDuralumin"), 'B', new ItemStack(IUItem.circuitSpectral), 'C', new ItemStack(IUItem.machines, 1, 2), 'A', new ItemStack(IUItem.advQuantumtool));
        ...
        for (int k = 0; k < BlockMoreMachine.names.length; k++) {
            if (k % 3 == 1) {
                ...
                Recipes.advRecipes.addRecipe(new ItemStack(IUItem.machines_base, 1, k),
                        "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.quantumtool), 'D', new ItemStack(IUItem.cirsuitQuantum), 'C', new ItemStack(IUItem.machines_base, 1, k - 1), 'B', OreDictionary.getOres("doubleplatePlatinum"), 'A', OreDictionary.getOres("doubleplateVitalium"));
            }
            if (k % 3 == 2) {

                Recipes.advRecipes.addRecipe(new ItemStack(IUItem.machines_base, 1, k),
                        "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.advQuantumtool), 'D', new ItemStack(IUItem.circuitSpectral), 'C', new ItemStack(IUItem.machines_base, 1, k - 1), 'B', OreDictionary.getOres("doubleplateSpinel"), 'A', OreDictionary.getOres("doubleplateCobalt"));

            }
            if (k % 3 == 0) {
                Recipes.advRecipes.addRecipe(new ItemStack(IUItem.machines_base, 1, k),
                        "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.nanoBox), 'D', new ItemStack(IUItem.QuantumItems9), 'C', stackmachine[k / 3], 'B', OreDictionary.getOres("doubleplateAluminium"), 'A', OreDictionary.getOres("doubleplateAlumel"));

            }

        }
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.machines_base1, 1, 0),
                "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.nanoBox), 'D', new ItemStack(IUItem.QuantumItems9), 'C', Ic2Items.recycler, 'B', OreDictionary.getOres("doubleplateAluminium"), 'A', OreDictionary.getOres("doubleplateAlumel"));

        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.machines_base1, 1, 1),
                "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.quantumtool), 'D', new ItemStack(IUItem.cirsuitQuantum), 'C', new ItemStack(IUItem.machines_base1, 1, 0), 'B', OreDictionary.getOres("doubleplatePlatinum"), 'A', OreDictionary.getOres("doubleplateVitalium"));
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.machines_base1, 1, 2),
                "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.advQuantumtool), 'D', new ItemStack(IUItem.circuitSpectral), 'C', new ItemStack(IUItem.machines_base1, 1, 1), 'B', OreDictionary.getOres("doubleplateSpinel"), 'A', OreDictionary.getOres("doubleplateManganese"));
        ...
        for (int i = 0; i < 12; i++) {
            ...
            switch (k) {
                ...
                case 1:
                    Recipes.advRecipes.addRecipe(new ItemStack(IUItem.machines_base2, 1, i),
                            "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.nanoBox), 'D', new ItemStack(IUItem.QuantumItems9), 'C', new ItemStack(IUItem.machines_base2, 1, i - 1), 'B', OreDictionary.getOres("doubleplateAluminium"), 'A', OreDictionary.getOres("doubleplateAlumel"));

                    break;
                case 2:
                    Recipes.advRecipes.addRecipe(new ItemStack(IUItem.machines_base2, 1, i),
                            "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.quantumtool), 'D', new ItemStack(IUItem.cirsuitQuantum), 'C', new ItemStack(IUItem.machines_base2, 1, i - 1), 'B', OreDictionary.getOres("doubleplatePlatinum"), 'A', OreDictionary.getOres("doubleplateVitalium"));

                    break;
                case 3:
                    Recipes.advRecipes.addRecipe(new ItemStack(IUItem.machines_base2, 1, i),
                            "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.advQuantumtool), 'D', new ItemStack(IUItem.circuitSpectral), 'C', new ItemStack(IUItem.machines_base2, 1, i - 1), 'B', OreDictionary.getOres("doubleplateSpinel"), 'A', OreDictionary.getOres("doubleplateManganese"));
                ...
                case 0:
                    if (i == 0) {
                        ...
                        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.machines_base3, 1, 4),
                                "ABA", "CDC", "FEF", 'F', new ItemStack(IUItem.compresscarbon), 'E', Ic2Items.recycler, 'D', Ic2Items.compressor, 'C', new ItemStack(IUItem.QuantumItems9), 'B', OreDictionary.getOres("plateVanadoalumite"), 'A', OreDictionary.getOres("plateAluminumbronze"));

                    }
                    break;
                case 1:
                    Recipes.advRecipes.addRecipe(new ItemStack(IUItem.machines_base3, 1, i),
                            "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.nanoBox), 'D', new ItemStack(IUItem.QuantumItems9), 'C', new ItemStack(IUItem.machines_base3, 1, i - 1), 'B', OreDictionary.getOres("doubleplateAluminium"), 'A', OreDictionary.getOres("doubleplateAlumel"));

                    break;
                case 2:
                    Recipes.advRecipes.addRecipe(new ItemStack(IUItem.machines_base3, 1, i),
                            "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.quantumtool), 'D', new ItemStack(IUItem.cirsuitQuantum), 'C', new ItemStack(IUItem.machines_base3, 1, i - 1), 'B', OreDictionary.getOres("doubleplatePlatinum"), 'A', OreDictionary.getOres("doubleplateVitalium"));

                    break;
                case 3:
                    Recipes.advRecipes.addRecipe(new ItemStack(IUItem.machines_base3, 1, i),
                            "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.advQuantumtool), 'D', new ItemStack(IUItem.circuitSpectral), 'C', new ItemStack(IUItem.machines_base3, 1, i - 1), 'B', OreDictionary.getOres("doubleplateSpinel"), 'A', OreDictionary.getOres("doubleplateManganese"));
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.machines_base1, 1, 7),
                "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.quantumtool), 'D', new ItemStack(IUItem.QuantumItems9), 'C', new ItemStack(IUItem.machines_base1, 1, 6), 'B', OreDictionary.getOres("doubleplateAluminium"), 'A', OreDictionary.getOres("doubleplateAlumel"));
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.machines_base1, 1, 8),
                "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.advQuantumtool), 'D', new ItemStack(IUItem.cirsuitQuantum), 'C', new ItemStack(IUItem.machines_base1, 1, 7), 'B', OreDictionary.getOres("doubleplatePlatinum"), 'A', OreDictionary.getOres("doubleplateVitalium"));
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.machines_base1, 1, 9),
                "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.advQuantumtool), 'D', new ItemStack(IUItem.circuitSpectral), 'C', new ItemStack(IUItem.machines_base1, 1, 8), 'B', OreDictionary.getOres("doubleplateSpinel"), 'A', OreDictionary.getOres("doubleplateManganese"));


        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.machines_base1, 1, 3),
                "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.quantumtool), 'D', new ItemStack(IUItem.QuantumItems9), 'C', new ItemStack(IUItem.machines_base1, 1, 2), 'B', OreDictionary.getOres("doubleplateAluminium"), 'A', OreDictionary.getOres("doubleplateAlumel"));
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.machines_base1, 1, 4),
                "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.advQuantumtool), 'D', new ItemStack(IUItem.cirsuitQuantum), 'C', new ItemStack(IUItem.machines_base1, 1, 3), 'B', OreDictionary.getOres("doubleplatePlatinum"), 'A', OreDictionary.getOres("doubleplateVitalium"));
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.machines_base1, 1, 5),
                "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.advQuantumtool), 'D', new ItemStack(IUItem.circuitSpectral), 'C', new ItemStack(IUItem.machines_base1, 1, 4), 'B', OreDictionary.getOres("doubleplateSpinel"), 'A', OreDictionary.getOres("doubleplateManganese"));
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.basemachine, 1, 12),
                "ABA", "CEC", "DDD", 'E', Ic2Items.advancedMachine, 'D', Ic2Items.advancedAlloy, 'C', new ItemStack(IUItem.QuantumItems9), 'A', OreDictionary.getOres("plateCobalt"), 'B', new ItemStack(Items.diamond));
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.basemachine, 1, 3),
                "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.nanoBox), 'D', new ItemStack(IUItem.QuantumItems9), 'C', new ItemStack(IUItem.machines, 1, 4), 'B', OreDictionary.getOres("doubleplateAluminium"), 'A', OreDictionary.getOres("doubleplateAlumel"));
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.basemachine, 1, 0),
                "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.nanoBox), 'D', new ItemStack(IUItem.QuantumItems9), 'C', Ic2Items.kineticGenerator, 'B', OreDictionary.getOres("doubleplateAluminium"), 'A', OreDictionary.getOres("doubleplateAlumel"));
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.basemachine, 1, 1),
                "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.quantumtool), 'D', new ItemStack(IUItem.cirsuitQuantum), 'C', new ItemStack(IUItem.basemachine, 1, 0), 'B', OreDictionary.getOres("doubleplatePlatinum"), 'A', OreDictionary.getOres("doubleplateVitalium"));
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.basemachine, 1, 2),
                "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.advQuantumtool), 'D', new ItemStack(IUItem.circuitSpectral), 'C', new ItemStack(IUItem.basemachine, 1, 1), 'B', OreDictionary.getOres("doubleplateSpinel"), 'A', OreDictionary.getOres("doubleplateManganese"));
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.basecircuit, 1, 8),
                "CCC", "ABA", "DDD", 'D', OreDictionary.getOres("ingotSpinel"), 'C', Ic2Items.carbonPlate, 'B', new ItemStack(IUItem.QuantumItems9), 'A', new ItemStack(IUItem.basecircuit, 1, 2));
        ...
        Recipes.advRecipes.addShapelessRecipe(new ItemStack(IUItem.lathingprogram), new ItemStack(Ic2Items.odScanner.getItem(), 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Ic2Items.turningBlankIron.getItem(), 1, 344865));
        Recipes.advRecipes.addShapelessRecipe(new ItemStack(IUItem.lathingprogram), new ItemStack(Ic2Items.odScanner.getItem(), 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Ic2Items.turningBlankIron.getItem(), 1, 275508));
        Recipes.advRecipes.addShapelessRecipe(new ItemStack(IUItem.lathingprogram), new ItemStack(Ic2Items.odScanner.getItem(), 1, OreDictionary.WILDCARD_VALUE), new ItemStack(Ic2Items.turningBlankIron.getItem(), 1, 274978));

        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.paints),
                "AAA", "A A", "AAA", 'A', new ItemStack(Items.iron_ingot));
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.paints, 1, 1), "AB ", 'A', new ItemStack(IUItem.paints), 'B', new ItemStack(Items.dye, 1, 12));
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.quarrymodule), "BAB", "DCD", 'D', OreDictionary.getOres("ingotGermanium"), 'C', new ItemStack(IUItem.module_schedule), 'B', new ItemStack(IUItem.QuantumItems9), 'A', new ItemStack(IUItem.machines, 1, 8)
        );
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.analyzermodule), "BAB", "DCD", 'D', OreDictionary.getOres("ingotGermanium"), 'C', new ItemStack(IUItem.module_schedule), 'B', new ItemStack(IUItem.cirsuitQuantum), 'A', new ItemStack(IUItem.basemachine1, 1, 2)
        );

        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.machinekit, 1, 0),
                "ABA", "D D", "EEE", 'E', new ItemStack(IUItem.nanoBox), 'D', new ItemStack(IUItem.QuantumItems9), 'B', OreDictionary.getOres("doubleplateAluminium"), 'A', OreDictionary.getOres("doubleplateAlumel"));


        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.machinekit, 1, 1),
                "ABA", "D D", "EEE", 'E', new ItemStack(IUItem.quantumtool), 'D', new ItemStack(IUItem.cirsuitQuantum), 'B', OreDictionary.getOres("doubleplatePlatinum"), 'A', OreDictionary.getOres("doubleplateVitalium"));


        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.machinekit, 1, 2),
                "ABA", "D D", "EEE", 'E', new ItemStack(IUItem.advQuantumtool), 'D', new ItemStack(IUItem.circuitSpectral), 'B', OreDictionary.getOres("doubleplateSpinel"), 'A', OreDictionary.getOres("doubleplateManganese"));
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.entitymodules, 1, 1), "ABA", "DCD", "EBE", 'A', new ItemStack(IUItem.QuantumItems9), 'B', new ItemStack(IUItem.alloyscasing, 1, 6), 'C', new ItemStack(IUItem.module_schedule), 'D', OreDictionary.getOres("ingotGermanium"), 'E', new ItemStack(IUItem.alloyscasing, 1, 9));
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.spawnermodules, 1, 1),
                "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.nanoBox), 'D', new ItemStack(IUItem.QuantumItems9), 'B', OreDictionary.getOres("doubleplateAluminium"), 'A', OreDictionary.getOres("doubleplateAlumel"), 'C', new ItemStack(IUItem.spawnermodules, 1, 0));


        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.spawnermodules, 1, 2),
                "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.quantumtool), 'D', new ItemStack(IUItem.cirsuitQuantum), 'B', OreDictionary.getOres("doubleplatePlatinum"), 'A', OreDictionary.getOres("doubleplateVitalium"), 'C', new ItemStack(IUItem.spawnermodules, 1, 1));
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.spawnermodules, 1, 4), " C ", "ABA", " C ", 'B', new ItemStack(IUItem.module_schedule, 1), 'A', OreDictionary.getOres("doubleplateNichrome"), 'C', new ItemStack(Items.experience_bottle)
        );
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.spawnermodules, 1, 5),
                "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.nanoBox), 'D', new ItemStack(IUItem.QuantumItems9), 'B', OreDictionary.getOres("doubleplateAluminium"), 'A', OreDictionary.getOres("doubleplateAlumel"), 'C', new ItemStack(IUItem.spawnermodules, 1, 4));
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.blockdoublemolecular), "BDB", "CAC", "BDB", 'C', new ItemStack(IUItem.cirsuitQuantum), 'B', Ic2Items.advancedMachine, 'A', new ItemStack(IUItem.blockmolecular), 'D', new ItemStack(IUItem.tranformer, 1, 1)
        );
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.basemachine1, 1, 2), "BBB", "CAC", "DED", 'D', OreDictionary.getOres("plateAlumel"), 'E', new ItemStack(IUItem.cirsuitQuantum), 'A', Ic2Items.advancedMachine, 'B', Ic2Items.iridiumPlate, 'C', new ItemStack(IUItem.plastic_plate)
        );
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.basemachine1, 1, 6),
                "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.nanoBox), 'D', new ItemStack(IUItem.QuantumItems9), 'C', Ic2Items.pump, 'B', OreDictionary.getOres("doubleplateAluminium"), 'A', OreDictionary.getOres("doubleplateAlumel"));


        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.basemachine1, 1, 7),
                "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.quantumtool), 'D', new ItemStack(IUItem.cirsuitQuantum), 'C', new ItemStack(IUItem.basemachine1, 1, 6), 'B', OreDictionary.getOres("doubleplatePlatinum"), 'A', OreDictionary.getOres("doubleplateVitalium"));
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.basemachine1, 1, 8), " C ", "BAB", " C ", 'C', new ItemStack(Items.experience_bottle), 'A', Ic2Items.machine, 'B', Ic2Items.electronicCircuit);
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.basemachine1, 1, 10), "EDE", "BAB", "EDE", 'E', OreDictionary.getOres("plateAluminumbronze"), 'D', Ic2Items.electronicCircuit, 'B', new ItemStack(Blocks.obsidian), 'A', Ic2Items.generator
        );
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.quantumdrill), " D ", "ABC", " D ", 'D', new ItemStack(IUItem.cirsuitQuantum), 'B', new ItemStack(IUItem.quantumtool), 'A', new ItemStack(IUItem.quantumpickaxe, 1, OreDictionary.WILDCARD_VALUE), 'C', new ItemStack(IUItem.quantumshovel, 1, OreDictionary.WILDCARD_VALUE)
        );
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.spectraldrill), " D ", "ABC", " D ", 'D', new ItemStack(IUItem.circuitSpectral), 'B', new ItemStack(IUItem.advQuantumtool), 'A', new ItemStack(IUItem.spectralpickaxe, 1, OreDictionary.WILDCARD_VALUE), 'C', new ItemStack(IUItem.spectralshovel, 1, OreDictionary.WILDCARD_VALUE)
        );
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.quantumdrill),
                "TCT", "CDC", "BFB", 'T', OreDictionary.getOres("doubleplateMuntsa"), 'F', new ItemStack(Ic2Items.lapotronCrystal.getItem(), 1, OreDictionary.WILDCARD_VALUE), 'B', new ItemStack(IUItem.quantumtool, 1), 'D', new ItemStack(IUItem.nanodrill, 1, OreDictionary.WILDCARD_VALUE), 'C', new ItemStack(IUItem.cirsuitQuantum, 1));
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.bags, 1, 1), "BCB", "BAB", "B B", 'C', new ItemStack(Ic2Items.reBattery.getItem(), 1, OreDictionary.WILDCARD_VALUE), 'B', Ic2Items.carbonPlate, 'A', new ItemStack(IUItem.bags));
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.bags, 1, 2), "BCB", "BAB", "B B", 'C', new ItemStack(Ic2Items.advBattery.getItem(), 1, OreDictionary.WILDCARD_VALUE), 'B', new ItemStack(IUItem.compresscarbon), 'A', new ItemStack(IUItem.bags, 1, 1));
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.impjetpack),
                "TCT", "CDC", "BFB", 'T', OreDictionary.getOres("doubleplateMuntsa"), 'F', new ItemStack(Ic2Items.reBattery.getItem(), 1, OreDictionary.WILDCARD_VALUE), 'B', new ItemStack(IUItem.quantumtool, 1), 'D', new ItemStack(IUItem.advjetpack, 1, OreDictionary.WILDCARD_VALUE), 'C', new ItemStack(IUItem.cirsuitQuantum, 1));
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.reactorCondensatorDiamond), "   ", "AB ", "   ", 'A', new ItemStack(IUItem.reactorCondensatorDiamond, 1, OreDictionary.WILDCARD_VALUE), 'B', new ItemStack(Blocks.diamond_block));
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.advventspread, 1),
                "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.nanoBox), 'D', new ItemStack(IUItem.QuantumItems9), 'C', new ItemStack(Ic2Items.reactorVentSpread.getItem(), 1, OreDictionary.WILDCARD_VALUE), 'B', OreDictionary.getOres("doubleplateAluminium"), 'A', OreDictionary.getOres("doubleplateAlumel"));


        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.impventspread, 1),
                "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.quantumtool), 'D', new ItemStack(IUItem.cirsuitQuantum), 'C', new ItemStack(IUItem.advventspread, 1, OreDictionary.WILDCARD_VALUE), 'B', OreDictionary.getOres("doubleplatePlatinum"), 'A', OreDictionary.getOres("doubleplateVitalium"));

        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.reactoradvVent, 1),
                "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.nanoBox), 'D', new ItemStack(IUItem.QuantumItems9), 'C', new ItemStack(Ic2Items.reactorVentGold.getItem(), 1, OreDictionary.WILDCARD_VALUE), 'B', OreDictionary.getOres("doubleplateAluminium"), 'A', OreDictionary.getOres("doubleplateAlumel"));


        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.reactorimpVent, 1),
                "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.quantumtool), 'D', new ItemStack(IUItem.cirsuitQuantum), 'C', new ItemStack(IUItem.reactoradvVent, 1, OreDictionary.WILDCARD_VALUE), 'B', OreDictionary.getOres("doubleplatePlatinum"), 'A', OreDictionary.getOres("doubleplateVitalium"));
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.advheatswitch, 1),
                "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.nanoBox), 'D', new ItemStack(IUItem.QuantumItems9), 'C', new ItemStack(Ic2Items.reactorHeatSwitch.getItem(), 1, OreDictionary.WILDCARD_VALUE), 'B', OreDictionary.getOres("doubleplateAluminium"), 'A', OreDictionary.getOres("doubleplateAlumel"));
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.impheatswitch, 1),
                "ABA", "DCD", "EEE", 'E', new ItemStack(IUItem.quantumtool), 'D', new ItemStack(IUItem.cirsuitQuantum), 'C', new ItemStack(IUItem.advheatswitch, 1, OreDictionary.WILDCARD_VALUE), 'B', OreDictionary.getOres("doubleplatePlatinum"), 'A', OreDictionary.getOres("doubleplateVitalium"));
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.upgradeblock), "DDD", "BAB", "CCC", 'D', OreDictionary.getOres("doubleplateVanadoalumite"), 'B', new ItemStack(IUItem.cirsuitQuantum), 'A', Ic2Items.advancedMachine, 'C', IUItem.quantumtool
        );
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.basemachine2, 1, 3), "   ", "ABC", "   ", 'A', new ItemStack(IUItem.module8), 'B', Ic2Items.machine, 'C', Ic2Items.electronicCircuit
        );
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.basemachine2, 1), "   ", " BC", "   ", 'B', Ic2Items.lathe, 'C', Ic2Items.electronicCircuit
        );
        ...
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.convertersolidmatter, 1), "EDE", "ABC", "FDF", 'F', new ItemStack(IUItem.quantumtool), 'E', new ItemStack(IUItem.cirsuitQuantum), 'A', Ic2Items.replicator, 'C', Ic2Items.scanner, 'B', Ic2Items.advancedMachine, 'D', new ItemStack(IUItem.core, 1, 6)
        );
        Recipes.advRecipes.addRecipe(new ItemStack(IUItem.basemachine2, 1, 4), "EDE", "BAB", "CCC", 'A', Ic2Items.advancedMachine, 'B', new ItemStack(IUItem.entitymodules, 1, 1), 'C', new ItemStack(IUItem.advQuantumtool), 'D', new ItemStack(IUItem.circuitSpectral), 'E', OreDictionary.getOres("doubleplateMuntsa"));
