...
public class InvSlotSintezator1 extends InvSlot {



    public InvSlotSintezator1(TileEntityInventory base1, int oldStartIndex1) {
        super(base1, "input3", oldStartIndex1, InvSlot.Access.IO, 4, InvSlot.InvSide.TOP);
