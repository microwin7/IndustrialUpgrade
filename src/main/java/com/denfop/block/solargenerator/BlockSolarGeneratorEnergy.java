...
public class BlockSolarGeneratorEnergy extends Block implements ITileEntityProvider {



	public BlockSolarGeneratorEnergy() {
		super(Material.iron);
		setHardness(3.0F);
		setCreativeTab(IUCore.tabssp);
		GameRegistry.registerBlock(this,
				ItemSolarGeneratorEnergy.class, "generator_se");
	}
