...
public class BlockAdvSolarGenerator extends Block implements ITileEntityProvider {
	


	public BlockAdvSolarGenerator() {
		super(Material.iron);
		setHardness(3.0F);
		setCreativeTab(IUCore.tabssp);
		GameRegistry.registerBlock(this,
				ItemAdvSolarGenerator.class, "advgenerator_se");
	}
	...
	public TileEntity createNewTileEntity(World world, int metadata) {
		return new TileAdvSolarGenerator();
	}
	@Override
