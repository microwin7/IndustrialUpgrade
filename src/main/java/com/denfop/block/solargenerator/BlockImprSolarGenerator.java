...
public class BlockImprSolarGenerator extends Block implements ITileEntityProvider {


	public BlockImprSolarGenerator() {
		super(Material.iron);
		setHardness(3.0F);
		setCreativeTab(IUCore.tabssp);
		GameRegistry.registerBlock(this,
				ItemImprSolarGenerator.class, "impgenerator_se");
	...
	public TileEntity createNewTileEntity(World world, int metadata) {
		return new TileImpSolarGenerator();
	}
	@Override
	...
	public void breakBlock(World world, int i, int j, int k, Block par5, int par6) {
		...
		if (tileentity != null)
			...
			dropItems((TileSolarGeneratorEnergy) tileentity, world);
	...
	private void dropItems(TileSolarGeneratorEnergy tileentity, World world) {
