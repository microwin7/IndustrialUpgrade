...
public class BlockConverterSolidMatter extends Block implements ITileEntityProvider {


	public BlockConverterSolidMatter() {
		super(Material.iron);
		setHardness(3.0F);
		setCreativeTab(IUCore.tabssp);
		GameRegistry.registerBlock(this, ItemBlockConverterSolidMatter.class, "BlockConverterSolidMatter");

	}
	public void registerBlockIcons(IIconRegister par1IconRegister) {  }
	@Override
	public TileEntity createNewTileEntity(World world, int metadata) {
		return new TileEntityConverterSolidMatter();
	}
	@Override
	...
	public void breakBlock(World world, int i, int j, int k, Block par5, int par6) {
		...
		if (tileentity != null)
			...
			dropItems((TileEntityConverterSolidMatter) tileentity, world);
