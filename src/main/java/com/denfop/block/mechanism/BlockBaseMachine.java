...
public class BlockBaseMachine extends BlockContainer {
	public BlockBaseMachine() {
		...
		GameRegistry.registerBlock(this, ItemBaseMachine.class,"machines");
	}
	...
	public TileEntity createTileEntity(World world, int meta) {
		...
		case 9:
			return new  TileEntityModuleMachine();
			case 10:
				return new TileEntityGeneratorAdv();
			case 11:
				return new TileEntityGeneratorImp();
			case 12:
				return new TileEntityGeneratorPer();
			case 13:
				return new TileEntityAdvQuantumQuarry();
			case 14:
				return new TileEntityImpQuantumQuarry();
			case 15:
				return new TileEntityPerQuantumQuarry();


		}
		return null;
	}
    public static final String[] names = {"GenMatter","GenMatter2","GenMatter3","Alloy","NeutronGen","Circuit","GenCobble","Quarry","ModuleMachine","advgenerator","impgenerator","pergenerator","Quarry1","Quarry2","Quarry3"};
	...
	public void registerBlockIcons(final IIconRegister par1IconRegister) {
		...
		for (int i = 1; i < names.length+1; i++) {
			IIcon[] icons = TextureAtlasSheet.unstitchIcons(par1IconRegister, Constants.TEXTURES_MAIN +"block" + names[i-1], 12,
					1);
