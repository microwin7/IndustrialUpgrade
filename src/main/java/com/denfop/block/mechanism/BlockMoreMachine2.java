...
public class BlockMoreMachine2 extends BlockContainer {
	public static final String[] names = new String[] { "Recycler", "Recycler1", "Recycler2","CombRecycler", "CombRecycler1", "CombRecycler2"  ,"CombMacerator", "CombMacerator1", "CombMacerator2","CombMacerator3"};
	...
	public BlockMoreMachine2() {
		...
		GameRegistry.registerBlock(this, ItemMoreMachine2.class,
				"machines_base1");
	}
