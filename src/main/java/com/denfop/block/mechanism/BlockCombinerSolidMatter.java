...
import com.denfop.item.mechanism.ItemBlockCombinerSolidMatter;
...
public class BlockCombinerSolidMatter extends Block implements ITileEntityProvider {


    public BlockCombinerSolidMatter() {
        super(Material.iron);
        setHardness(3.0F);
    ...
    public void breakBlock(World world, int i, int j, int k, Block par5, int par6) {
        ...
        if (tileentity != null)
            ...
            dropItems((TileEntityCombinerSolidMatter) tileentity, world);
    ...
    private void dropItems(TileEntityCombinerSolidMatter tileentity, World world) {
