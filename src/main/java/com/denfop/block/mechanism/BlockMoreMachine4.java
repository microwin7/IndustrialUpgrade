...
import com.denfop.item.mechanism.ItemMoreMachine4;
...
public class BlockMoreMachine4 extends BlockContainer {
    ...
    public BlockMoreMachine4() {
        ...
        GameRegistry.registerBlock(this, ItemMoreMachine4.class,
                "machines_base3");
    }
    ...
    public TileEntity createTileEntity(World world, int meta) {
        switch (meta) {
            case 0:
                return new TileEntityFermer();
            case 1:
                return new TileEntityDoubleFermer();
            case 2:
                return new TileEntityTripleFermer();
            case 3:
                return new TileEntityQuadFermer();
            case 4:
                return new TileEntityAssamplerScrap();
            case 5:
                return new TileEntityDoubleAssamplerScrap();
            case 6:
                return new TileEntityTripleAssamplerScrap();
            case 7:
                return new TileEntityQuadAssamplerScrap();
