...
import com.denfop.item.mechanism.ItemBlockOilRefiner;
...
public class BlockOilRefiner extends Block implements ITileEntityProvider {


    public BlockOilRefiner() {
        super(Material.iron);
        setHardness(3.0F);
    ...
    public void breakBlock(World world, int i, int j, int k, Block par5, int par6) {
        ...
        if (tileentity != null)
            ...
            dropItems((TileEntityOilRefiner) tileentity, world);
    ...
    private void dropItems(TileEntityOilRefiner tileentity, World world) {
