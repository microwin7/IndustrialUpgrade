...
public class BlockNetherOre1 extends Block {
    public static   List<String> itemNames;
    private IIcon[][] IIconsList;
    public BlockNetherOre1() {
        super(Material.iron);
        ...
        this.addItemsNames();
        GameRegistry.registerBlock(this,ItemBlockNetherOre1.class,"netherore1");
    }
    ...
    public ArrayList<ItemStack> getDrops(World world, int x, int y, int z, int metadata, int fortune)
    {
        ...
        if(ret.size() < 1)
            ret.add(new ItemStack(IUItem.netherore1, 1, metadata));
        return ret;
    }
    @Override
    ...
    public void addItemsNames() {
        itemNames.add("nethertinrack");
        itemNames.add("netheruranrack");
        itemNames.add("netheralumrack");
        itemNames.add("nethertitanrack");
        itemNames.add("nethercobaltrack");
