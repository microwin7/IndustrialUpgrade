...
import com.denfop.tiles.mechanism.TileEntityQCable.CableRenderState;
...
public class ModelQCable extends AbstractModel implements ISpecialParticleModel {
    ...
    private static ResourceLocation getTextureLocation(QEType type, int insulation, boolean active) {
        String loc = "blocks/wiring/qcable/" + type.getName(insulation);
