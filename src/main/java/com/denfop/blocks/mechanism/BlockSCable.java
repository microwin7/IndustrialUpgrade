...
public enum BlockSCable implements ITeBlock {

    scable(TileEntitySCable.class, -1),
    ;


    public static final ResourceLocation IDENTITY = IUCore.getIdentifier("scable");
    ...
    public static void buildDummies() {
        ...
        for (final BlockSCable block : values()) {
