...
public enum BlockPetrolQuarry implements ITeBlock, ITeBlockSpecialItem {
    ...
    public static final ResourceLocation IDENTITY = IUCore.getIdentifier("petrol_quarry");
    ...
    BlockPetrolQuarry(final Class<? extends TileEntityBlock> teClass, final int itemMeta, final EnumRarity rarity) {
    ...
    public static void buildDummies() {
        ...
        for (final BlockPetrolQuarry block : values()) {
