...
public class NEIRolling extends MachineRecipeHandler {
    public NEIRolling() {
    }
    ...
    public String getRecipeName() {
        return StatCollector.translateToLocal("iu.blockRolling.name");
    }
    ...
    public Map<IRecipeInput, RecipeOutput> getRecipeList() {
        return Recipes.metalformerRolling.getRecipes();
    }
}
