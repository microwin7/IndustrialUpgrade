...
public class NEIGenerationHelium extends TemplateRecipeHandler {
    ...
    public String getRecipeName() {
        return StatCollector.translateToLocal("iu.blockHelGen.name");
    }
    ...
    public Map<NBTTagCompound, FluidStack> getRecipeList() {
        return Recipes.heliumgenerator.getRecipes();
    }
    ...
    public void drawBackground(int i) {
        ...
        GuiDraw.drawString(StatCollector.translateToLocal("cost.name") + " " + ModUtils.getString((double) recipe.tag.getInteger("amount")) + "EU", 10, 30, 4210752);
