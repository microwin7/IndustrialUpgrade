...
public class NEIFermer extends MachineRecipeHandler {
    public NEIFermer() {
    }
    ...
    public void drawBackground(int i) {
        ...
        drawTexturedModalRect(getInputPosX(), getInputPosY() + 19, 176, 14, 16, 24);
    ...
    public void drawExtras(int i) {
        ...
        drawProgressBar(getInputPosX() - 2, getInputPosY() + 19, 176 + 16, 14, 16, 24, f, 1);
    ...
    public Map<IRecipeInput, RecipeOutput> getRecipeList() {
        return Recipes.fermer.getRecipes();
    }
}
