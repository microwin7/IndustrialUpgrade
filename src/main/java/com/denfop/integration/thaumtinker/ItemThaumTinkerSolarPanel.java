...
public class ItemThaumTinkerSolarPanel extends ItemBlock implements IPanel {
    private final List<String> itemNames;

    public ItemThaumTinkerSolarPanel(final Block b) {
        super(b);
        this.setMaxDamage(0);
    ...
    public void addItemsNames() {
        this.itemNames.add("blockIhorSolarPanel");
    }
    ...
    public void addInformation(ItemStack itemStack, EntityPlayer player, List info, boolean b) {
        if (Config.promt) {
            ...
            TileEntitySolarPanel tile = (TileEntitySolarPanel) blockThaumTinkerSolarPanel.getBlockEntity(meta);
