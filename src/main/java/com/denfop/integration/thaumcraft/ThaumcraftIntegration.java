...
public class ThaumcraftIntegration {
    ...
    public static void init() {
        ...
        MATTERY = new Aspect("mattery", Helpers.convertRGBcolorToInt(178, 5, 199), new Aspect[]{Aspect.LIFE, Aspect.WATER}, new ResourceLocation(Constants.TEXTURES, "textures/aspect/materia.png"), 771);
