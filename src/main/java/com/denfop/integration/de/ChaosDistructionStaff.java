...
public class ChaosDistructionStaff extends MiningTool
	...
	public ChaosDistructionStaff() {
		...
		setCapacity(BalanceConfigHandler.draconicToolsBaseStorage * 2
				+ BalanceConfigHandler.draconicWeaponsBaseStorage * 2);
		setMaxExtract(BalanceConfigHandler.draconicToolsMaxTransfer * 2
				+ BalanceConfigHandler.draconicWeaponsMaxTransfer * 2);
		setMaxReceive(BalanceConfigHandler.draconicToolsMaxTransfer * 2
				+ BalanceConfigHandler.draconicWeaponsMaxTransfer * 2);
	...
	public List<ItemConfigField> getFields(ItemStack stack, int slot) {
		...
		list.add((new ItemConfigField(2, slot, "WeaponAttackAOE")).setMinMaxAndIncromente(0,
				EnumUpgrade.ATTACK_AOE.getUpgradePoints(stack), 1)
	...
	public boolean onLeftClickEntity(ItemStack stack, EntityPlayer player, Entity entity) {
		...
		ToolHandler.AOEAttack(player, entity, stack,
				IConfigurableItem.ProfileHelper.getInteger(stack, "WeaponAttackAOE", 0));
		return true;
	}
	...
	public int getCapacity(ItemStack stack) {
		...
		return BalanceConfigHandler.draconicToolsBaseStorage * 2 + BalanceConfigHandler.draconicWeaponsBaseStorage * 2
				+ points * (BalanceConfigHandler.draconicToolsStoragePerUpgrade * 2
						+ BalanceConfigHandler.draconicWeaponsStoragePerUpgrade * 2);
	}
